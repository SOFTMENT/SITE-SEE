...
const ServiceProfile = (props) => {
    ...
    const { profilePic, name,uid,membershipActive} = userData
    ...
    return (
        <ScrollView style={styles.container} bounces={false} showsVerticalScrollIndicator={false}>
            <Header back navigation={navigation} title="Account"
                // rightIcon={"logout"}
            ...
            <Text style={styles.email}>{userData.email}</Text>
            {
                membershipActive&&
                <View>
                   <Text style={styles.sub}> Membership Active</Text>
                </View>
            }
...
export default connect(mapStateToProps)(ServiceProfile)